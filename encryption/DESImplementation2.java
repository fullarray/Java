/*
	Created by Jonathan H. fullarray
*/
...
public class DESImplementation {
	...
	private void printBytes(byte[] input) {		
		//String value = new String(input, "UTF-8");
		String str;
		
		for (int i = 0 ; i < input.length; i++) {
			//System.out.print(byteToBits(input[i]) + " ");
			str = byteToBits(input[i]);
			//System.out.print(int2str(str) + " ");
			//InputStream is = new ByteArrayInputStream(str.getBytes("UTF-8"));
			System.out.print(int2str(str) + " ");
			
		}
		//System.out.println(int2str(str));
		System.out.println();
	}
	
	public static String experiment(String text){
	...
	public static String int2str( String t ) { 
		...
		for ( int i = 0; i < ss.length; i++ ) { 
		    int charCode = Integer.parseInt( ss[i], 2 );
	...
	public static void main(String[] args){
		...
		//String smessage = "The lazy dog jumps over the lazy dog.";
		//byte[] message = Base64.getEncoder().encode(smessage.getBytes());
		...
		//String ss = Base64.getEncoder().encodeToString(key);
		...
		//String sss = Base64.getEncoder().encodeToString(cipher);
		//System.out.println(sss);
		des.printBytes(cipher);
		
		byte[] result = des.crypt(cipher, key, "decrypt");
		System.out.println("Decrypted Text:");
		//byte[] resultDecode = Base64.getDecoder().decode(result);
		//String ssss = new String(resultDecode);
